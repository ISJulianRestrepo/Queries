...
f120_id Item,
	   ...
	   (select f200_id from t200_mm_terceros where f200_rowid =t350.f350_rowid_tercero) as IdTercero,
	   (select f200_razon_social from t200_mm_terceros where f200_rowid =t350.f350_rowid_tercero) as Tercero
